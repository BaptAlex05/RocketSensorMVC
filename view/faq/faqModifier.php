...
<?php ob_start(); ?>
	<section>	
		...
		<div class="faq_ajouter">
			<p><a href="/RocketSensorMVC/index.php?section=faq">Retour à la FAQ</a></p>

			<form method="post" action="/RocketSensorMVC/index.php?section=faq&page=modifierTraitement&id=<?=$_GET['id']?>">
